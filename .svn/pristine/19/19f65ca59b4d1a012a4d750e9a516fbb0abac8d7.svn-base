{-| 
    ...
    Description : Módulo que contém a função principal (@gera@) da Tarefa 1.

    Este módulo define funções comuns da Tarefa 2 do trabalho prático.

    = Introdução
     
    Esta tarefa está destinada, para a génese do 'Mapa'. A partir de uma de uma lista de números
    aleatórios era necessário associar esses números a informação do 'Mapa'.

    = Objetivos

    Dividiu-se o trabalho em dois principais objetivos. O primeiro era o processamento da informação
    da lista gerada aleatoriamente. O segundo objetivo era, pegar na informação processada e associa-la
    a um 'Piso' e ao tipo de 'Peca'. Apesar, de ser algo básico, esta foi a nossa primeira tarefa e,
    portanto, foi um desafio muito intimidante e desafiador. Pelo que, a eficiência e elegância do 
    código não foi dos objetivos que recebeu primazia.

    = Conclusão

    Conseguimos fazer o que estava proposto, no entanto, se fizessemos esta tarefa no final do trabalho
    tinhamos feito muitas funções de forma mais elegante.
